...
public class NewMsgReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (TextUtils.equals(intent.getAction(), IMChatManager.NEW_MSG_ACTION)) {
            ...
            context.sendBroadcast(new Intent("com.imkfsdk.msgreceiver"));
            //看应用是否在前台
            if (!isAppForground(context)) {
                ...
                //新的通知
                NotificationCompat.Builder builder = new NotificationCompat.Builder(MoorUtils.getApp(), "1");
