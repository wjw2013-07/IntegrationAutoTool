...
import com.sdk.chat.LoadingFragmentDialog;
import com.sdk.constant.Constants;
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                if (FaceConversionUtil.getInstace().emojis == null || FaceConversionUtil.getInstace().emojis.size() == 0) {
                    com.sdk.utils.FaceConversionUtil.getInstace().getFileText(
                            context);
                }
            }
        }).start();
            ...
            public void run() {
                IMChatManager.getInstance().setOnInitListener(new InitListener() {
                    ...
                    public void onInitFailed() {
                        ...
                        loadingDialog.dismiss();
                        Log.d("7m", "sdk初始化失败, 请填写正确的accessid");
                    }
                });
